...
const StickerPeel = ({
  ...
  initialPosition = 'center', // On garde simple
  peelDirection = 0,
  className = ''
}) => {
  ...
  // 🎯 VERSION SIMPLIFIÉE - Pas de positionnement initial complexe
  useEffect(() => {
    const target = dragTargetRef.current;
    if (!target) return;

    // Juste s'assurer qu'il est visible
  ...
  useEffect(() => {
    ...
    const boundsEl = document.getElementById('skills');
